...
export function generateDynamicMendixCode(
  ...
  const code = [
    ...
    '                try {',
    '                    // === LOG AJOUTÉ : Tentative de création ===',
    '                    console.log("[DEBUG] Tentative de création d\'un objet dans", entity);',
    '                    console.log("[DEBUG] Attributs passés:", JSON.stringify(attributes));',
    '                    // =======================================',
    '                    mx.data.create({',
    '                        entity: entity,',
    ...
    '                                    callback: function() {',
    '                                        // === LOG AJOUTÉ : Succès ===',
    '                                        console.log("[DEBUG] Création réussie pour", entity);',
    '                                        // =========================',
    '                                        console.log("[SUCCESS] Entity committed: " + entity);',
    '                                        resolve(obj);',
    '                                    },',
    '                                    error: function(e) {',
    '                                        // === LOG AJOUTÉ : Erreur Commit ===',
    '                                        console.error("[ERROR] Commit échoué pour", entity, ":", e.message);',
    '                                        // ==================================',
    ...
    '                                });',
    '                            } catch (err) {',
    '                                // === LOG AJOUTÉ : Erreur Configuration ===',
    '                                console.error("[ERROR] Configuration échouée pour", entity, ":", err.message);',
    '                                // =======================================',
    ...
    '                        },',
    '                        error: function(e) {',
    '                            // === LOG AJOUTÉ : Erreur Création ===',
    '                            console.error("[ERROR] Création échouée pour", entity, ":", e.message);',
    '                            // ==================================',
    ...
    '                    });',
    '                } catch (err) {',
    '                    // === LOG AJOUTÉ : Erreur Globale ===',
    '                    console.error("[ERROR] Erreur globale lors de la tentative de création pour", entity, ":", err.message);',
    '                    // ==================================',
    ...
    '            // === LOG AJOUTÉ : Début de la fonction ===',
    '            console.log(`[DEBUG createAggregationEntities] Appel pour nœud: ${node.name} (Niveau: ${level.name})`);',
    '            // =======================================',
    ...
    '            // === LOG AJOUTÉ : Vérification de la condition ===',
    '            console.log(`[DEBUG createAggregationEntities] Vérification condition pour ${node.name}: isMachineLevel=${levelName === "Machine"}, hasMetadataVariable=${!!node.metadata?.variable}`);',
    '            if (node.metadata?.variable) { console.log("[DEBUG createAggregationEntities] Contenu node.metadata.variable:", JSON.stringify(node.metadata.variable)); } else { console.log("[DEBUG createAggregationEntities] node.metadata.variable est absent ou undefined."); }',
    '            // ===============================================',
    '            if (levelName === "Machine" && node.metadata.variable) {',
    '                // Code existant pour les machines',
    '                console.log(`[VARIABLE] Creating consumption variable for Machine:`, node.name);',
    '                const aggConsoAttributes = {',
    '                    "VariableId": node.metadata.variable.variableId,',
    '                    "VariableName": node.metadata.variable.variableName,',
    '                    "AssetName": node.name,',
    '                    [levelName]: node.name,',
    ...
    '                    aggConsoAttributes',
    '                );',
    '            } else if (levelName !== "Machine") {',
    '                // NOUVEAU: Traiter les variables par type d\'energie pour niveaux autres que Machine',
    '                const energyTypes = [',
