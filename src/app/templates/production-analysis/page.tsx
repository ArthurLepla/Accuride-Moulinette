...
// Données de test pour les machines
const machines = [
  { id: '1', name: 'Machine 1' },
  { id: '2', name: 'Machine 2' },
  { id: '3', name: 'Machine 3' },
...
export default function ProductionAnalysisPage() {
  ...
  const [selectedMachines, setSelectedMachines] = useState<string[]>(['1', '2', '3', '4']);
      ...
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg p-6 text-white">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-2xl font-bold mb-2">Analyse Production</h1>
              <div className="text-blue-100 flex items-center gap-2">
                <LineChart className="h-4 w-4" />
                <span>Analysez les performances énergétiques de votre production</span>
              </div>
            </div>
